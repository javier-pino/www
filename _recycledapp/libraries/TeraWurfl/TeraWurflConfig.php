...
class TeraWurflConfig {
	...
	public static $CAPABILITY_FILTER = false;
        ...
        /** Esta función garantiza que el terawulf utilice las variables de
         * configuracion 
         */
        public static function  set_all_td_variables() {
            
            //Se cargan las configuraciones de base de datos
            require APPPATH . 'config/database.php';

            TeraWurflConfig::$DB_HOST = $db[$active_group]['hostname'];
            TeraWurflConfig::$DB_USER = $db[$active_group]['username'];
            TeraWurflConfig::$DB_PASS = $db[$active_group]['password'];
            TeraWurflConfig::$DB_SCHEMA = "tera-wurfl";
            
        }      
}

    //Este código se ejecuta al inicializar la clase y carga las variables de tudescuenton
    TeraWurflConfig::set_all_td_variables();
