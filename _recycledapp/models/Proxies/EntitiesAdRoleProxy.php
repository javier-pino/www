 ...
 */
class EntitiesAdRoleProxy extends \Entities\AdRole implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setAdTreeMenuId($adTreeMenuId);
    }

    public function getAdTreeMenuId()
    {
        $this->__load();
        return parent::getAdTreeMenuId();
    }
