...
/**
 * This is the model class for table "m_storage_historical".
 *
 * The followings are the available columns in table 'm_storage_historical':
 * @property string $M_Storage_Historical_ID
 * @property string $Created
 * @property string $CreatedBy
 * @property string $Updated
 * @property string $UpdatedBy
 * @property string $Month_Closure
 ...
 * @property MLot $mLot
 */
class MStorageHistorical extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MStorageHistorical the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('Created, Month_Closure, M_Locator_ID, M_Supply_ID, M_Lot_ID, M_AttributeSetInstance_ID', 'required'),
			...
			array('M_Storage_Historical_ID, Created, CreatedBy, Updated, UpdatedBy, Month_Closure, M_Locator_ID, M_Supply_ID, M_Lot_ID, M_AttributeSetInstance_ID, QtyOnHand, QtyIn, QtyProcess', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'M_Storage_Historical_ID' => 'M Storage Historical',
			'Created' => 'Created',
	...
	public function search()
	{
		...
		$criteria->compare('M_Storage_Historical_ID',$this->M_Storage_Historical_ID,true);
		$criteria->compare('Created',$this->Created,true);
		$criteria->compare('CreatedBy',$this->CreatedBy,true);
		$criteria->compare('Updated',$this->Updated,true);
		$criteria->compare('UpdatedBy',$this->UpdatedBy,true);
		$criteria->compare('Month_Closure',$this->Month_Closure,true);
